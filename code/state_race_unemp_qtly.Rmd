...
Coefficient of variation cutoffs: 0.10, 0.15, 0.20 0.25
...
current_quarter_output <- cps %>% 
  ...
  select(state, st_abbr, gender, wbhao, n, subgroup_urate,
         st_urate_6mos, ratio, laus_qtr_unemp, qtr_st_urate_by_reg, se, cv, thresh.10:thresh.25) %>% # Clean our data up
