...
#add pct format
addStyle(EARN_staterace_umemp, 'State urates', style=pct, cols=c(2:121), rows=2:(nrow(urates_wbhao_state)+1), gridExpand=TRUE)
...
saveWorkbook(EARN_staterace_umemp,here(paste0("data/EARN_qtrly_st_race_unemp_", format(Sys.time(), "%d-%b-%Y %H.%M"), ".xlsx")), overwrite = TRUE)
```
